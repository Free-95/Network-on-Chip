`timescale 1ns / 1ps
module xy_router #(parameter COORD_WIDTH = 1)(
    input  wire [COORD_WIDTH-1:0] curr_x, curr_y, dest_x, dest_y,
    output reg  [4:0]             out_port_req
);
    localparam PORT_LOCAL = 5'b00001, PORT_NORTH = 5'b00010, PORT_SOUTH = 5'b00100;
    localparam PORT_EAST  = 5'b01000, PORT_WEST  = 5'b10000;
    always @(*) begin
